...
unpacker.vec3l = function (pointer, buffer) {
	var binary = new Float32Array( buffer.buffer, pointer.offset,  3); 
	pointer.offset += 4 * 3;
	return binary;
};

unpacker.vec4l = function (pointer, buffer) {
	var binary = new Float32Array( buffer.buffer, pointer.offset, 4); 
	pointer.offset += 4 * 4;
	return binary;
};
